...
WMHextraction_kNNdiscovery_Step3(){
	...
	if [ -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_LablMap.nii ]; then
		...
		gzip -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_LablMap.nii
	fi
	if [ -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_ProbMap.nii ]; then
		...
		gzip -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_ProbMap.nii
	fi
	if [ -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_refinementKNN.nii ]; then
		...
		gzip -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_refinementKNN.nii
	fi
	if [ -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_Prob${probThr_str}.nii ]; then
		...
		gzip -f ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_Prob${probThr_str}.nii
	fi
	...
	# set sform code
	# This is because I noticed both sform code and qform code are set to 0 in Renji data
	${FSLDIR}/bin/fslorient -setsformcode 1 ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_ProbMap
	${FSLDIR}/bin/fslorient -setsformcode 1 ${subj_dir}/${ID}/mri/extractedWMH/${ID}_WMH_Prob${probThr_str}
	...
	# --------------------------------------------------
	# No. of WMH clusters in lobar segments and globally <-- meaning No. of voxels
	# --------------------------------------------------
	...
	Vol_Ltemporal_WMHclusters=`${FSLDIR}/bin/fslstats ${subj_dir}/${ID}/mri/extractedWMH/lobarWMH/${ID}_Ltemporal_WMH -V | awk '{print $2}'`
	Vol_Rtemporal_WMHclusters=`${FSLDIR}/bin/fslstats ${subj_dir}/${ID}/mri/extractedWMH/lobarWMH/${ID}_Rtemporal_WMH -V | awk '{print $2}'`
	Vol_Lparietal_WMHclusters=`${FSLDIR}/bin/fslstats ${subj_dir}/${ID}/mri/extractedWMH/lobarWMH/${ID}_Lparietal_WMH -V | awk '{print $2}'`
	Vol_Rparietal_WMHclusters=`${FSLDIR}/bin/fslstats ${subj_dir}/${ID}/mri/extractedWMH/lobarWMH/${ID}_Rparietal_WMH -V | awk '{print $2}'`
	Vol_Loccipital_WMHclusters=`${FSLDIR}/bin/fslstats ${subj_dir}/${ID}/mri/extractedWMH/lobarWMH/${ID}_Loccipital_WMH -V | awk '{print $2}'`
	Vol_Roccipital_WMHclusters=`${FSLDIR}/bin/fslstats ${subj_dir}/${ID}/mri/extractedWMH/lobarWMH/${ID}_Roccipital_WMH -V | awk '{print $2}'`
	...
	echo "UBO Detector: counting WMH clusters (ID = ${ID})..."
	...
	do
		...
		## whole brain NoC subclassification
	...
	# ----------------------
	# Wring NoC to text file
	# ----------------------

	echo "UBO Detector: writing number of clusters to text file (ID = ${ID})..."

	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	date >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "--==  Number of WMH clusters (any size) ==--" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "No_of_WholeBrain_WMHclusters	${N_WhlBrn_cluster}" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	...
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "--== Number of WMH clusters (punctuate) ==--" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "No_of_WholeBrain_WMHclusters_punctuate	${N_WhlBrn_cluster_punctuate}" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	...
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "--== Number of WMH clusters (focal) ==--" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "No_of_WholeBrain_WMHclusters_focal	${N_WhlBrn_cluster_focal}" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	...
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "--== Number of WMH clusters (medium) ==--" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "No_of_WholeBrain_WMHclusters_medium	${N_WhlBrn_cluster_medium}" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	...
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "--== Number of WMH clusters (confluent) ==--" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "No_of_WholeBrain_WMHclusters_confluent	${N_WhlBrn_cluster_confluent}" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt
	echo "" >> ${studyFolder}/subjects/${ID}/stats/${ID}_WMH_NoC.txt

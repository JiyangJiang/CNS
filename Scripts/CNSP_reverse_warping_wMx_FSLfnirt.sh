...
invWarping(){
	...
	echo "CNSP_reverse_warping_wMx_FSLfnirt.sh: Flirting ${src_filename} to MNI_2mm standard (estimating affine) ..."
	...
	echo "CNSP_reverse_warping_wMx_FSLfnirt.sh: Fnirting ${src_filename} to MNI_2mm standard (estimating warping) ..."
	fnirt --in=${src} \
